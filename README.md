...
**Meeplewood** is designed around several board game data sources, mainly logged plays from Board Game Stats and collection data exports from BoardGameGeek. The goal is to bring these data sources together in one place and turn them into useful insights and playful decision support for board game enthusiasts.
...
This also includes data from **Spiel preview lists** that are announced via BoardGameGeek every year before **Spiel**.
